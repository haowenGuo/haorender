...
void barycentric5(const Vector4f& pts0, const Vector4f& pts1, const Vector4f& pts2, float x,float y, float&x0, float& y0, float& z0) {
...
void barycentric6(const Vector4f& pts0, const Vector4f& pts1, const Vector4f& pts2, float x, float y, float& x0, float& y0, float& z0) {
	float s1x = pts2[0] - pts0[0];
	float s1y = pts2[1] - pts0[1];
	float s2x = pts1[0] - pts0[0];
	float s2y = pts1[1] - pts0[1];
